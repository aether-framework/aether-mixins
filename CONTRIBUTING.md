## Contributing to Aether Mixins

Thank you for your interest in contributing to Aether Mixins! 🎉
...
2. Clone your fork:
```sh
git clone https://github.com/aether-framework/aether-mixins.git
cd aether-mixins
```
...
```
Use a meaningful branch name (e.g., `fix/refmap-bug` or `feature/yarn-integration`).
