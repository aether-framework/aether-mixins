...
public interface ConfigurationSection {
     ...
     * possible, final but may miss any values out if they are not compatible.
     *
     * @param path Path of the List to get.
     ...
     * default value was specified, this will return an empty List.
     * <p>
     * This method will attempt to cast any values into a Map if possible, final but
     ...
     * Objects to Strings. However, #getObject(path, final boolean.class) is
     ...
     * @return Requested object
     */
    @Nullable <T> T getObject(@NotNull final String path, @NotNull Class<T> clazz);
    ...
    @Nullable <T> T getObject(@NotNull final String path, @NotNull final Class<T> clazz, @Nullable final T def);
     ...
     */
    @Nullable <T extends ConfigurationSerializable> T getSerializable(@NotNull final String path, @NotNull final Class<T> clazz);
     ...
     */
    @Contract("_, _, !null -> !null")
    @Nullable <T extends ConfigurationSerializable> T getSerializable(@NotNull final String path, @NotNull final Class<T> clazz, @Nullable final T def);
