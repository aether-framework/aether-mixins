...
public class AgentBootE2E {
    ...
    void childJvmStartsWithAgent() throws Exception {
        ...
        JvmRunner.Result r = JvmRunner.runWithAgent("e2e.statics.GreeterMain", List.of(), props);
    ...
    void injectHeadApplied() throws Exception {
        ...
        var r = JvmRunner.runWithAgent("e2e.statics.GreeterMain", List.of(), Map.of("aether.mixins.config", cfg));
    ...
    void redirectOrdinalSecondCall() throws Exception {
        ...
        var r = JvmRunner.runWithAgent("e2e.statics.GreeterTwiceMain", List.of(), Map.of("aether.mixins.config", cfg));
        assertEquals(0, r.exitCode, () -> "Exit: " + r.exitCode + "\n--- STDOUT ---\n" + r.stdout + "\n--- STDERR ---\n" + r.stderr);
    ...
    void redirectInvokeVirtualApplied() throws Exception {
        ...
        var r = JvmRunner.runWithAgent("e2e.statics.GreeterVirtualMain", List.of(), Map.of("aether.mixins.config", cfg));
        assertEquals(0, r.exitCode, () -> "Exit: " + r.exitCode + "\n--- STDOUT ---\n" + r.stdout);
    ...
    void redirectInvokeInterfaceApplied() throws Exception {
        ...
        var r = JvmRunner.runWithAgent("e2e.statics.UseInterfaceMain", List.of(), Map.of("aether.mixins.config", cfg));
        assertEquals(0, r.exitCode);
    ...
    void injectCtorHeadAndTail() throws Exception {
        ...
        assertNotNull(url);
        var cfg = Paths.get(url.toURI()).toAbsolutePath().toString();
        var r = JvmRunner.runWithAgent("e2e.statics.CtorMain", List.of(), Map.of("aether.mixins.config", cfg));
    ...
    void invokestaticApplied() throws Exception {
        ...
        var r = JvmRunner.runWithAgent("e2e.statics.StaticCallerMain", List.of(),
    ...
    void invokespecialPrivateApplied() throws Exception {
        ...
        var r = JvmRunner.runWithAgent(
                "e2e.statics.PrivateSpecialMain", List.of(),
                Map.of("aether.mixins.config", cfg)
        );
    ...
    void invokespecialSuperCallApplied() throws Exception {
        ...
        var cfg = java.nio.file.Paths.get(url.toURI()).toString();
        var r = JvmRunner.runWithAgent("e2e.statics.SubSuperMain", List.of(), Map.of("aether.mixins.config", cfg));
        assertEquals(0, r.exitCode, r.stderr);
    ...
    void injectTailPriorityOrdering() throws Exception {
        ...
        var cfg = java.nio.file.Paths.get(url.toURI()).toString();
        var r = JvmRunner.runWithAgent("e2e.statics.TailOrderMain", List.of(), Map.of("aether.mixins.config", cfg));
        assertEquals(0, r.exitCode, r.stderr);
    ...
    void redirectPriorityHighWins() throws Exception {
        ...
        var cfg = java.nio.file.Paths.get(url.toURI()).toString();
        var r = JvmRunner.runWithAgent("e2e.statics.RedirPrioMain", List.of(), Map.of("aether.mixins.config", cfg));
        assertEquals(0, r.exitCode, r.stderr);
    ...
    void injectTailMultiReturn() throws Exception {
        ...
        assertNotNull(url);
        var cfg = Paths.get(url.toURI()).toAbsolutePath().toString();
        var r = JvmRunner.runWithAgent("e2e.statics.MultiTailMain", List.of(), Map.of("aether.mixins.config", cfg));
        assertEquals(0, r.exitCode, r.stderr);
    ...
    void redirectAndInjectOrder() throws Exception {
        ...
        var r = JvmRunner.runWithAgent("e2e.statics.OrderPlayMain", List.of(), Map.of("aether.mixins.config", cfg));
        assertEquals(0, r.exitCode, r.stderr);
    ...
    void tailInjectWithTryCatchStrictFrames() throws Exception {
        ...
        var r = JvmRunner.runWithAgent("e2e.statics.FrameCaseMain", List.of(), Map.of("aether.mixins.config", cfg));
        assertEquals(0, r.exitCode, r.stderr);
