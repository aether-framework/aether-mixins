...
@Mixin(targets = "e2e.statics.api.UseInterface", priority = 100)
public final class UseInterfaceMixin {
    @Redirect(
            method = "callIface()Ljava/lang/String;",
            callOwner = "e2e/statics/api/IService",
            callName = "ping",
            callDesc = "()Ljava/lang/String;",
            kind = Redirect.InvokeKind.INVOKEINTERFACE
    )
    public static String replaceIface(final e2e.statics.api.IService self) { // Receiver = Interface-Typ
        return "PATCHED-IF";
    }
}